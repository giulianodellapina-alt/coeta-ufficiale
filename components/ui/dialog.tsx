...
function DialogTrigger({ nativeButton, ...props }: DialogPrimitive.Trigger.Props) {
  return (
    <DialogPrimitive.Trigger
      ...
      nativeButton={
        nativeButton ??
        (React.isValidElement(props.render) && typeof props.render.type === "string"
